...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(_readModel.chapters[indexPath.row].title==nil){//提取目录失败
        cell.textLabel.text = [NSString stringWithFormat:@"chapter %ld",(long)indexPath.row];
    }
   // if(![_readModel.content isEqualToString:@"pdf"]){
