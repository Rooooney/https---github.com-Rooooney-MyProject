...
-(void)changeFont:(UIButton *)sender
{
    ...
    if(![_readModel.chapterModel.content isEqualToString:@"pdf"]){
...
-(void)observeValueForKeyPath:(NSString *)keyPath ofObject:(id)object change:(NSDictionary<NSString *,id> *)change context:(void *)context
{
    ...
    if ([keyPath isEqualToString:@"readModel.chapter"] || [keyPath isEqualToString:@"readModel.page"]) {
        ...
        //        }
        [_progressView title:_readModel.chapterModel.title==nil?@"":_readModel.chapterModel.title progress:[NSString stringWithFormat:@"%.1f%%",_slider.value]];
