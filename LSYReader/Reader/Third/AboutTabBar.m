...
- (void)viewDidLoad {
    ...
    aboutTab = [[UILabel alloc]initWithFrame:CGRectMake(self.view.bounds.size.width/2-40, 40, 80,80)];
    aboutTab.text = @"我是关于";
...
-(void)viewWillLayoutSubviews{
    ...
    aboutTab.frame = CGRectMake(self.view.bounds.size.width/2-40, 40, 80,80);
